  ...
  return (
    <>
      ...
      <main className={`flex flex-col items-center justify-center min-h-screen bg-background`}>
        {/* Hero Section */}
        <section className="w-full bg-blue-600 bg-opacity-40 backdrop-blur-lg text-white py-20 px-5 text-center rounded-b-3xl">
          ...
          <Button className="bg-white text-blue-600 hover:bg-blue-100 rounded-lg shadow-lg">
            Get Started
          </Button>
        </section>
        {/* About Section */}
        <section id="about" className="w-full py-16 px-5 text-center max-w-4xl bg-white shadow-lg rounded-lg backdrop-blur-md">
        ...
        <section id="services" className="w-full bg-gray-100 py-16 px-5 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="p-6 bg-white shadow-lg rounded-lg backdrop-blur-md">
        ...
        <section id="contact" className="w-full py-16 px-5 text-center max-w-4xl">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            ...
            ></textarea>
            <Button className="bg-blue-600 text-white hover:bg-blue-700 md:col-span-2 rounded-lg shadow-lg">
              Send Message
            </Button>
          </form>
        </section>
